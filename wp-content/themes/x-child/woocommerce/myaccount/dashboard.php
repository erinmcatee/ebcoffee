...
<p>
	<?php
		echo sprintf( esc_attr__( 'Hello! You\'re currently logged-in as %s%s%s (not you? %sSign out%s)', 'woocommerce' ), '<strong>', esc_html( $current_user->user_email ), '</strong>', '<a href="' . esc_url( wc_get_endpoint_url( 'customer-logout', '', wc_get_page_permalink( 'myaccount' ) ) ) . '">', '</a>' );
	?>
</p>
