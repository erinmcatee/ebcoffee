...
?><dl class="component"><?php
	...
	<dd class="component-<?php echo sanitize_html_class( $key ); echo empty( $component_data[ 'value' ] ) ? ' component-hidden' : ''; ?>"><?php echo wp_kses_post( wpautop( wp_strip_all_tags($component_data[ 'value' ]) ) ); ?></dd>
</dl>
